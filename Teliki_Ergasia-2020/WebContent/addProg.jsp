...
<title>Add new telephone program</title>
</head>
<body>
<% 
	//clear the cache
...
<form action="<%= request.getContextPath()%>/AddNewProgServlet" method="post">
		<table>
			<tr>
			...
			<tr>
				<td></td>
				<td><input type="submit" value="Add Telephone Program"></td>
			</tr>
		</table>
	</form>
</body>
